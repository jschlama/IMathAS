...
if ($isOldChrome) {
  echo '<script defer="defer" src="'.$staticroot.'/assess2/vue/js/gbviewassess-legacy.js?v=IgOQe9R4"></script>';
} else {
?>
<script defer="defer" type="module" src="<?php echo $staticroot;?>/assess2/vue/js/gbviewassess.js?v=4jtuzpuL"></script>
<script defer="defer" nomodule src="<?php echo $staticroot;?>/assess2/vue/js/gbviewassess-legacy.js?v=IgOQe9R4"></script>
<?php
}
